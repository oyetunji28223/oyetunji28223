document.addEventListener('DOMContentLoaded', () => {
    ...
    const fetchSystemStatus = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                const li = document.createElement('li');
                li.textContent = `Error loading wallets: ${data.detail || response.statusText}`;
                walletsListUl.appendChild(li);
    ...
    getStatusBtn.addEventListener('click', fetchSystemStatus);
        ...
        try {
            ...
            if (response.ok) {
                if (data.profitEvents && data.profitEvents.length > 0) {
                    ...
                    profitEventsResultArea.innerHTML = '';
