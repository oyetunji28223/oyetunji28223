        ...
        try:
            ...
            if weekly_total < billion_target:
                ...
                if clone_wallet not in wallets:
                    if len(wallets) < MAX_SIMULATED_WALLETS:
                        ...
                        logging.warning(f"Wallet {wallet}: Skipped cloning to {clone_wallet} because MAX_SIMULATED_WALLETS limit of {MAX_SIMULATED_WALLETS} was reached.")
            else:
